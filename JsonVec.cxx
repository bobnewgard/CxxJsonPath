...
namespace JsonParse
{
    ...
    JsonVec::set_obj_bgn(void)
    {
        ...
        JsonToken tmp_token(json_styp_obj_bgn);

        this->vec->push_back(tmp_token);
    ...
    {
        JsonToken tmp_token(json_styp_obj_end);
    ...
    {
        JsonToken tmp_token(json_styp_arr_bgn);
    ...
    {
        JsonToken tmp_token(json_styp_arr_end);
    ...
    JsonVec::set_obj_key(char * arg_str)
    {
        if (arg_str == nullptr)
        {
            JsonToken tmp_token(json_styp_key, json_etyp_str, string(""));
        
            this->vec->push_back(tmp_token);
        
            if (this->msg)
            {
                this->msg->cerr_inf((DQ + tmp_token.element_str + DQ + CN).c_str());
            }
        }
        else
        {
            JsonToken tmp_token(json_styp_key, json_etyp_str, string(arg_str));
    ...
    {
        JsonToken tmp_token(json_styp_elem, json_etyp_nul);
    ...
    {
        JsonToken tmp_token(json_styp_elem, json_etyp_tru);
    ...
    {
        JsonToken tmp_token(json_styp_elem, json_etyp_fal);
    ...
    JsonVec::set_elem_str(char * arg_str)
    {
        if (arg_str == nullptr)
        {
            JsonToken tmp_token(json_styp_elem, json_etyp_str, string(""));
        
            this->vec->push_back(tmp_token);
        
            if (this->msg)
            {
                this->msg->cerr_inf((DQ + tmp_token.element_str + DQ).c_str());
            }
        }
        else
        {
            JsonToken tmp_token(json_styp_elem, json_etyp_str, string(arg_str));
    ...
    JsonVec::set_elem_num(char * arg_str)
    {
        if (arg_str == nullptr)
        {
            JsonToken tmp_token(json_styp_elem, json_etyp_num, string(""));
        
            this->vec->push_back(tmp_token);
        
            if (this->msg)
            {
                this->msg->cerr_inf(tmp_token.element_str.c_str());
            }
        }
        else
        {
            JsonToken tmp_token(json_styp_elem, json_etyp_num, string(arg_str));
