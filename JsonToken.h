 ...
 */
    ...
    /** \brief Public namespace for the JsonPath library
     *
     *  The JsonPath library is separated into two namespaces, JsonPath
     *  and JsonParser.  The JsonParser namespace is intended to be
     *  visible only inside the JsonPath library, and not visible to
     *  users of the library.  This separation may be enforced by 
     *  installing only JsonToken.h, JsonFind.h and JsonStr.h into
     *  /usr/include/JsonPath
     */
    namespace JsonPath
    {
        ...
        // TBD, dox >= 1.8.2
        const std::array <std::string, json_styp_LAST> str_json_struct
        {
            {
                "obj_bgn",
                "obj_end",
        ...
        // TBD, dox >= 1.8.2
        const std::array <std::string, json_etyp_LAST> str_json_element
        {
            {
                "str",
                "num",
         ...
         *
         *  This class is used by the JSON parser that underlies JsonPath
        ...
        class JsonToken
        {
            ...
            JsonToken(JsonStructTypes, JsonElementTypes, const std::string&);
            ...
            void dump_token    ( std::string& );
            bool get_token_str ( std::string& );
        };
        ...
        typedef std::vector    <JsonToken>::iterator       TokenI;
        typedef std::vector    <JsonToken>::const_iterator TokenCI;
